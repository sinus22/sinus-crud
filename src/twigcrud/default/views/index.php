...
<?= $generator->indexWidgetType === 'grid' ? "{{ use('yii/grid/GridView') }} \n" : "{{ use('yii/widgets/ListView') }} \n" ?>
...
<div class="<?= Inflector::camel2id(StringHelper::basename($generator->modelClass)) ?>-index">
    ...
    <p>
        <a href="{{ path(['create']) }}"
           class="btn btn-success"><?= $generator->generateTString('Create ' . Inflector::camel2words(StringHelper::basename($generator->modelClass))) ?></a>
    </p>
    <?= $generator->enablePjax ?"{{ pjax_begin() }} \n": "" ?>
